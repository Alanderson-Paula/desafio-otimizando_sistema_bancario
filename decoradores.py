...
def log_transacao(func):
    ...
    def envelope(*args, **kwargs):
        ...
        if resultado:
            ...
            print('─' * 50)
            print('\n')
        # return resultado  # Retorna o valor original da função
...
def mens_alertas(func):
    ...
    def envelope(*args):
        ...
        if comando == "Alerta":
            ...
            var1, var2 = Fore.RED, Fore.YELLOW
        else:
            var1, var2 = Fore.BLACK, Fore.BLACK

        resultado = f"\n{var1}⚠  {var2}{mensagem}{Style.RESET_ALL}\n"
        return resultado
    return envelope
...
#         resultado = func(*args, **kwargs)
#         print(
#             f'\n{datetime.now().strftime("%d/%m/%Y %H:%M:%S")}: {func.__name__.replace("_", " ").title()}')
#         print('─' * 50)
#         print('\n')
#         return resultado
#     return envelope
